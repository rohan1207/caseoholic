const VALUES = [
  ...
  },
  {
    ...
    body: "Free standard shipping on all orders above $50. Express delivery available nationwide.",
  },
  {
    icon: (
      <svg
    ...
    <>
      <style>{`
        ...
        .bv-icon {
          ...
          color: #d97706; margin-bottom: 14px; flex-shrink: 0;
        }
        ...
        .bv-body {
          font-size: 12.5px; color: #78716c; line-height: 1.6;
        }
      `}</style>
