...
const products = {
  "Phone Cases": [
    ...
    },
    {
      ...
      price: 2499,
      image: "/iphone21.webp",
      hoverImage: "/iphone22.webp",
    },
    {
      id: "pc3",
      name: "MagSafe Silicone",
      subtitle: "iPhone 15 / 14",
      price: 1799,
      image: "/iphone31.webp",
      hoverImage: "/iphone32.webp",
    },
    {
      id: "pc4",
      name: "Carbon Armor",
  ...
  "AirPods Cases": [
    {
      ...
      price: 999,
      image: "/airpod11.webp",
      hoverImage: "/airpod12.webp",
    },
    {
      id: "ac2",
      name: "Clear Snap Case",
      subtitle: "AirPods 3rd Gen",
      price: 699,
      image: "/airpod21.webp",
      hoverImage: "/airpod22.webp",
    },
    {
      id: "ac3",
      name: "Silicone Hook Case",
      subtitle: "AirPods Pro 2nd Gen",
      price: 849,
      image: "/airpod31.webp",
      hoverImage: "/airpod32.webp",
    },
    {
      id: "ac4",
      name: "Woven Fabric Case",
      subtitle: "AirPods 2nd Gen",
      price: 749,
      image: "/airpod41.webp",
      hoverImage: "/airpod42.webp",
    },
  ],
  "Watch Bands": [
    {
      id: "wb1",
      name: "Milanese Loop",
      subtitle: "Apple Watch 45mm",
      price: 1999,
      image: "/iwatchband11.webp",
      hoverImage: "/iwatchband12.webp",
    },
    {
      id: "wb2",
      name: "Braided Solo Loop",
      subtitle: "Apple Watch 41mm",
      price: 2299,
      image: "/iwatchband21.webp",
      hoverImage: "/iwatchband22.webp",
    },
    {
      id: "wb3",
      name: "Leather Link",
      ...
      hoverImage: "/iwatchband32.webp",
    },
    {
      id: "wb4",
      name: "Sport Fluoroelastomer",
      subtitle: "Apple Watch 41 / 45mm",
      price: 1499,
      image: "/iwatchband41.webp",
      hoverImage: "/iwatchband42.webp",
    },
  ],
  "Phone Wallets": [
    {
      ...
      subtitle: "iPhone 14 / 15 Series",
      price: 1699,
      image: "/magsafe11.webp ",
      hoverImage: "/magsafe12.webp",
    },
    {
      id: "pw2",
      name: "Leather Sleeve Wallet",
      subtitle: "Universal Fit",
      price: 2199,
      image: "/magsafe21.webp",
      hoverImage: "/magsafe22.webp",
    },
    {
      id: "pw3",
      name: "Bifold Card Case",
      subtitle: "iPhone 15 Pro",
      price: 1499,
      image: "/magsafe31.webp",
      hoverImage: "/magsafe32.webp",
    },
    {
      id: "pw4",
      name: "Zip Pouch Wallet",
      subtitle: "Universal Fit",
      price: 1899,
      image: "/magsafe41.webp",
      hoverImage: "/magsafe42.webp",
    },
  ],
};
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Corner round button — always visible, shrinks away on hover (cursor takes over) */}
        <Motion.button
          onClick={(e) => {
            e.stopPropagation();
            onAdd(product.id);
          ...
          style={{
            ...
            height: 44,
            borderRadius: "50%",
            background: added ? "#2a7a4a" : "#0e0e0e",
            border: "none",
            display: "flex",
            alignItems: "center",
...
export default function Bestseller() {
  ...
  const onCardEnter = useCallback(
    (e) => setCursor({ x: e.clientX, y: e.clientY, visible: true }),
    [],
  );
      ...
      >
        <Motion.div
          ...
          style={{
            ...
            height: 52,
            borderRadius: "50%",
            background: cursorAdded ? "#2a7a4a" : "#0e0e0e",
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
            transition: "background 0.3s ease",
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto" }}>
        ...
        <div
          style={{
            display: "flex",
            gap: 0,
            borderBottom: "0.5px solid #e4e0da",
            marginBottom: 52,
            overflowX: "auto",
          }}
        >
        ...
        <div
          style={{
            ...
            gap: "48px 24px",
            cursor: cursor.visible ? "none" : "auto",
          }}
