...
const PRODUCTS = [
  { id: 1, slug: "leather-case-tan", image: "/airpod11.webp", name: "Leather Case — Tan", price: "Rs.899", tag: "New" },
  { id: 2, slug: "silicone-case-midnight", image: "/airpod21.webp", name: "Silicone Case — Midnight", price: "Rs.599", tag: null },
  { id: 3, slug: "woven-case-sage", image: "/airpod31.webp", name: "Woven Case — Sage", price: "Rs.799", tag: "Hot" },
  { id: 4, slug: "hard-case-clear", image: "/airpod41.webp", name: "Hard Case — Crystal", price: "Rs.699", tag: null },
];
  ...
  return (
    <>
      <style>{`
        ...
        .acc-root *, .acc-root *::before, .acc-root *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ── Banner ── */
        .acc-banner { position: relative; width: 100%; overflow: hidden; background: white; }
        .acc-banner-inner {
          display: grid;
        ...
        .acc-banner-img-col { position: relative; height: 100%; min-height: 520px; overflow: hidden; }
        .acc-banner-img { width: 100%; height: 100%; object-fit: cover; object-position: center; display: block; }
        .acc-banner-content { padding: 64px 72px; display: flex; flex-direction: column; gap: 20px; }
        ...
        .acc-banner-cta:hover { background: #1a1816; color: #fff; gap: 16px; }

        /* ── Products ── */
        .acc-products { padding: 64px 48px 72px; }
        .acc-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 16px; }

        /* ── View All ── */
        .acc-viewall-row { display: flex; justify-content: flex-end; margin-top: 36px; }
        .acc-viewall {
          display: inline-flex; align-items: center; gap: 10px;
        ...
        .acc-viewall:hover { background: #1a1816; color: #fff; gap: 16px; }
        ...
        @media (max-width: 1024px) {
          ...
          .acc-quickview { display: none !important; }
          .acc-cursor { display: none !important; }
        }
        ...
        @media (max-width: 768px) {
          ...
          .acc-banner-img-col { min-height: 300px; }
          .acc-banner-content { padding: 36px 28px; }
          .acc-banner-title { font-size: clamp(1.6rem, 6vw, 2.4rem); }
        }
        @media (max-width: 640px) {
          .acc-products { padding: 36px 16px 52px; }
          .acc-grid { grid-template-columns: repeat(2, 1fr); gap: 10px; }
          .acc-banner-content { padding: 28px 20px; gap: 14px; }
        }
        @media (max-width: 380px) {
          .acc-products { padding: 28px 12px 40px; }
          .acc-grid { gap: 8px; }
        }
      `}</style>
      ...
      <div className="acc-root">
        ...
        <div className="acc-banner">
          <div className="acc-banner-inner">
            {/* Left: image */}
            <motion.div className="acc-banner-img-col" variants={bannerVariants} initial="hidden" animate="visible">
              <img src={BANNER.image} alt="AirPods Cases Collection" className="acc-banner-img" />
            </motion.div>

            {/* Right: content */}
            <div className="acc-banner-content">
              <motion.p className="acc-banner-eyebrow"
              ...
              <motion.h1 className="acc-banner-title"
              ...
              <motion.p className="acc-banner-desc"
                initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }}
